                ...
                <div class="grid grid-cols-1 lg:grid-cols-5 gap-16">
                    ...
                    <div class="lg:col-span-2" data-aos="fade-left">
                        ...
                        <div class="space-y-8">
                            ...
                            @foreach ([['Ubicación', 'Bogotá, Colombia<br>Calle 69 a # 90-25'], ['Teléfono', '+57 314 4916988'], ['Email', 'muebles.jemga@gmail.com'], ['Horario', 'Lunes – Viernes: 8am – 6pm<br>Sábados: 9am – 2pm']] as [$label, $value])
